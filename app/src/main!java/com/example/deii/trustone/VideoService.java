...
import com.example.deii.Utils.VideoPlayerInterface;

import java.io.IOException;

/**
 * Created by deii on 3/7/2016.
 */
public class VideoService extends Service implements MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnBufferingUpdateListener {

    public static final String ACTION_PLAY = "PLAY";
    private static String mUrl;
    private static VideoService mInstance = null;

    public static MediaPlayer mMediaPlayer = null;    // The Media Player
    private int mBufferPosition;
    private static String mSongTitle;
    private static String mSongPicUrl;
    private static VideoPlayerInterface playerInterface;
    ...
    public static VideoService getInstance(VideoPlayerInterface playerInterface1) {
